...
export const translations: TranslationDictionary = {
  ...
  review: { sq: "Ndrruar", en: "Review" },
  view_encar_diagnosis: { sq: "Shiko Diagnozën Encar", en: "View Encar Diagnosis" },
  accident_history: { sq: "Historiku i dëmtimeve", en: "Accident History" },
  owner_changes: { sq: "Ndërrimet e pronarit", en: "Owner Changes" },
  total_accidents: { sq: "Totali i dëmtimeve", en: "Total Accidents" },
  ...
  // Diagram view labels (front-body vs under-chassis frame)
  insp_view_body: { sq: "Karroceria", en: "Body" },
  insp_view_frame: { sq: "Korniza", en: "Frame" },
  // Panel marker letter codes (Encar legend)
  insp_marker_X: { sq: "Zëvendësim", en: "Exchange" },
  insp_marker_W: { sq: "Lamarinë / saldim", en: "Sheet metal / welding" },
  insp_marker_C: { sq: "Korrozion", en: "Corrosion" },
  insp_marker_A: { sq: "Gërvishtje", en: "Scratches" },
  insp_marker_U: { sq: "Sipërfaqe e parregullt", en: "Uneven surface" },
  insp_marker_T: { sq: "Dëmtim", en: "Impairment" },
